...
import { fetchCompanySubscriptions } from '../lib/insurance'

function CompanySubscriptionsContent() {
  ...
  useEffect(() => {
    const loadData = async () => {
      ...
      try {
        const data = await fetchCompanySubscriptions(profile.id)
    ...
    <ThemedView safe style={styles.container}>
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <ThemedText title style={styles.title}>
          Souscriptions recues
        </ThemedText>
        <ThemedText style={styles.subtitle}>
          Liste des souscriptions payees pour vos offres
        </ThemedText>
        ...
        {subscriptions.map((subscription) => (
          <ThemedCard key={subscription.id} style={styles.card}>
            ...
            <ThemedText>
              Souscripteur : {subscription.prenom} {subscription.nom}
            </ThemedText>
            <ThemedText>Email : {subscription.email}</ThemedText>
            <ThemedText>Telephone : {subscription.telephone}</ThemedText>
            <ThemedText>Adresse : {subscription.adresse}</ThemedText>
              ...
              onPress={() =>
                router.push({
                  ...
                  params: {
                    ...
                    companyName: profile?.nom_compagnie || '',
        ...
        {!subscriptions.length && (
          <ThemedCard style={styles.card}>
            <ThemedText>Aucune souscription payee n'a encore ete recue.</ThemedText>
          </ThemedCard>
        )}
      </ScrollView>
    </ThemedView>
